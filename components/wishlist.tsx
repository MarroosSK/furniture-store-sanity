        ...
        {wishlistData && wishlistData.productData?.length > 0 ? (
          <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 ">
            {wishlistData.productData.map((wishedItem: any) => (
              <div
                key={wishedItem._id}
                className="w-full relative group  border bg-white rounded-md p-4 hover:shadow-lg duration-200 shadow-gray-500  overflow-hidden group"
              >
                  ...
                  <div className={`relative `}>
                    ...
                    <div className="abosute bottom-0 flex items-center gap-5 justify-center translate-y-[110%] group-hover:-translate-y-2 transition-transform duration-300">
                      <button
                        ...
                        className="bg-white text-red-500 px-3 py-2 text-xs rounded-full flex items-center gap-1 hover:bg-gray-200   duration-200"
                      >
                        <span>
                          <X />
                        </span>
