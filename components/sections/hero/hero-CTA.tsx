...
export const HeroSectionCTA = () => {
  return (
    <div className="flex items-center gap-x-3 sm:gap-x-6">
      <Link href="#new" className="flex items-center gap-x-2">
          ...
          <Tooltip>
            <TooltipTrigger>
              <svg
                ...
                viewBox="0 0 29 29"
                fill="none"
                className="flex items-center justify-center gap-[8px] text-[15px] rotate-[45deg] w-[33px] h-[33px] p-[7px] bg-primary rounded-full"
              >
                <path
